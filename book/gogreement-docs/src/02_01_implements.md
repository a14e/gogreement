...
3. **@ignore not supported**: Intentional - you control the annotation, so violations should always be fixed
...
- [Limitations](01_02_limitations.md#7-ignore-does-not-work-with-implements)